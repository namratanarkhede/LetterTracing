...
void createShapes() {
  ...
  // C
   new Letter(new Vertex[]{
    new Vertex(LETTER_WIDTH, LETTER_HEIGHT * 0.2),
    new Vertex(LETTER_WIDTH * 0.7, 0),
    new Vertex(LETTER_WIDTH * 0.3, 0),
    new Vertex(0, LETTER_HEIGHT * 0.2),
    new Vertex(0, LETTER_HEIGHT * 0.8),
    new Vertex(LETTER_WIDTH * 0.3, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH * 0.7, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH, LETTER_HEIGHT * 0.8),
  }),
  // D
new Letter(new Vertex[]{
  new Vertex(0, 0),
  ...
  new Letter(new Vertex[]{
    ...
    new Vertex(0, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH * 0.7, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH, LETTER_HEIGHT * 0.6),
    new Vertex(LETTER_WIDTH * 0.5, LETTER_HEIGHT * 0.6),
  }),
  ...
  new Letter(new Vertex[]{
    ...
    new Vertex(LETTER_WIDTH, LETTER_HEIGHT * 0.5),
  ...
  new Letter(new Vertex[]{
    new Vertex(0, LETTER_HEIGHT),
    new Vertex(0, 0),
    new Vertex(LETTER_WIDTH * 0.5, LETTER_HEIGHT * 0.5),
    new Vertex(LETTER_WIDTH, 0),
    new Vertex(LETTER_WIDTH, LETTER_HEIGHT),
  }),
...
// N
  ...
  new Letter(new Vertex[]{
    new Vertex(0, 0),
    new Vertex(LETTER_WIDTH * 0.25, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH * 0.5, 0),
    new Vertex(LETTER_WIDTH * 0.75, LETTER_HEIGHT),
    new Vertex(LETTER_WIDTH, 0),
  }),
